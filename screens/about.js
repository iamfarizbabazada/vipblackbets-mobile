...
const About = () => {
  ...
  return (
    <View
      style={{ flex: 1, backgroundColor: '#252525', padding: 20 }}
    >
      <View style={{paddingHorizontal: 40, paddingVertical: 20, height: 220, borderRadius: 16, alignItems: 'center', justifyContent: 'space-between', gap: 10, backgroundColor: '#151515'}}>
        <Text style={{color: theme.colors.primary, fontSize: 54, fontWeight: 'bold'}}>VBB</Text>
        <Text style={{color: theme.colors.accent, fontSize: 18}}>Vipblackbets - 2024</Text>
        <Text style={{color: theme.colors.description, fontSize: 12, fontWeight: 'bold'}}>Versiya - V2.0</Text>
      </View>
