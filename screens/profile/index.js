  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={['#B8860B', '#7B5506']} style={styles.info}>
        <Image style={{ borderRadius: 16, flex: 1 }} source={{ uri: user.avatarURL }} />
        <View style={{ flex: 1 }}>
          <View style={{ gap: 8, marginVertical: 10 }}>
            <Text variant="titleLarge" style={{ color: '#000' }}>{user.name}</Text>
            <Text variant="bodySmall" style={{ color: '#252525' }}>{user.email}</Text>
          </View>
          <View style={styles.balanceContainer}>
            <View>
              <Text style={{color: theme.colors.accent}}>Balans</Text>
              <Text style={{color: theme.colors.primary, fontWeight: 'bold'}}>{user.currentBalance}₼</Text>
            </View>
            <View>
              <Text style={{color: theme.colors.accent}}>Bonus</Text>
              <Text style={{color: theme.colors.primary, fontWeight: 'bold'}}>5%</Text>
            </View>
          </View>
        </View>
      </LinearGradient>
